		...
		<main id="main" class="site-main" role="main">
			...
			<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				...
				<div class="memory-ln">
					...
					<a class="see-all" href="history">See All</a>
			...
			<?php foreach ( $event_posts as $post ) : setup_postdata( $post ); ?>
                   ...
                   <article class="wrapper__single-event third-child-display" style="background-image: url(<?php the_field('event_image');?>); background-size: cover; background-position: center;">
